...
% \label{my-label}
% \begin{tabular}{ll|ll}
% $n$ & \multicolumn{1}{l|}{$E_n$}  & $n$ & $E_n$  \\
%     & \multicolumn{1}{l|}{$\SI{\electronvolt}$}}   &     & $\SI{\electronvolt}$   \\ \hline
% 0   & \multicolumn{1}{l|}{-4.477} & 8   & -1.151 \\
% 1   & \multicolumn{1}{l|}{-3.962} & 9   & -0.867 \\
% 2   & \multicolumn{1}{l|}{-3.475} & 10  & -0.615 \\
% 3   & \multicolumn{1}{l|}{-3.017} & 11  & -0.400 \\
% 4   & \multicolumn{1}{l|}{-2.587} & 12  & -0.225 \\
% 5   & \multicolumn{1}{l|}{-2.185} & 13  & -0.094 \\
% 6   & \multicolumn{1}{l|}{-1.811} & 14  & -0.017 \\
% 7   & -1.466                      &     &       
% \end{tabular}
% \end{table}
